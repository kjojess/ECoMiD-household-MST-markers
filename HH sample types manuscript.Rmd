---
title: "HH sample types no models"
...
labels<-c("Rum2Bac (ruminant)", "Pig2Bac (pig)", "GFD (poultry)", "DG37 (dog)", "HF183 (human)", "GenBac3 (general)")
...
labels<-c("GenBac3 (general)", "HF183 (human)", "DG37 (dog)", "GFD (poultry)", "Pig2Bac (pig)", "Rum2Bac (ruminant)")
...
GenBac_plot<-data%>%
  ...
  geom_boxplot()+
  theme_minimal()+
  labs(y="Log gene copies per sample", x="Sample type")+
